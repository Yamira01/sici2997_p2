...
class Person {
    ...
    public static function loadByFirstName($firstName) {
        global $persons; //para buscar afuera
    ...
    public function save(){
        global $persons;
        if($this->id == -1){
            //si esta vacio es un insert
            $persons[]= [$this->firstName, $this->lastName1, $this->lastName1, $this->dateOfBirth];
            //key nuevo del objeto
           $keys = array_keys($persons);
            $this->id = $keys[count($keys)-1];
            
        }else{
            //update
        $persons[$this->id] = [$this->firstName, $this->lastName1, $this->lastName1, $this->dateOfBirth];
    }

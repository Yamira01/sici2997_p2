...
<header class="bgimg-1 w3-display-container w3-grayscale-min" id="home">
  <div  class="w3-display-left w3-text-white" style="padding:48px">
    ...
    <span class="w3-xxlarge w3-hide-large w3-hide-medium">ADAPTANDO EL MOVIMIENTO</span><br>
    <span class="w3-large">Terapia Física, Pilates y Educación</span>
    <p><a href="index.php?a=register" class="w3-button w3-black w3-padding-large w3-large w3-margin-top w3-hover-white">REGISTRATE</a></p>
  </div> 
  ...
  <div class="w3-row-padding" style="margin-top:64px">
    <div class="w3-third w3-section">
      <ul class="w3-ul w3-white w3-hover-shadow">
        <li class="w3-black w3-xlarge w3-padding-32">2 SEMANAS DE PRUEBA</li>
 ...
 <!-- Contact Section -->
  <div class="w3-container w3-padding-32" id="contact">
    ...
    <form action="/action_page.php" target="_blank">
      <input class="w3-input" type="text" placeholder="Nombre" required name="Name">
      <input class="w3-input w3-section" type="text" placeholder="Email" required name="Email">
      <input class="w3-input w3-section" type="text" placeholder="Asunto" required name="Subject">
      <input class="w3-input w3-section" type="text" placeholder="Comentario" required name="Comment">
